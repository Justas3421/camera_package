...
public class Messages {
  ...
  public interface CameraApi {
     ...
     */
    void setFocusDistance(@Nullable Double distance, @NonNull VoidResult result);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @NonNull String messageChannelSuffix, @Nullable CameraApi api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.camera_android.CameraApi.setFocusDistance" + messageChannelSuffix, getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Double distanceArg = (Double) args.get(0);
                VoidResult resultCallback =
                    new VoidResult() {
                      public void success() {
                        wrapped.add(0, null);
                ...
                api.setFocusDistance(distanceArg, resultCallback);
              });
        } else {
          channel.setMessageHandler(null);
        }
